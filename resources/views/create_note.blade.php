...
<div class="min-h-screen flex items-center justify-center bg-gray-100 px-4">
    <div class="w-full max-w-lg bg-white p-6 rounded shadow-md">
        ...
        <form method="POST" action="{{ route('notes.store') }}">
            ...
            <h2 class="text-2xl font-semibold mb-6 text-center">Create New Note</h2>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="title"
                    ...
                    value="{{ old('title') }}" placeholder="Note title (3-50 chars)">
                @error('title')
            ...
            <div class="mb-6">
                ...
                <textarea name="body" id="body" rows="5"
                    ...
                    placeholder="Write your note here (10-500 chars)">{{ old('body') }}</textarea>
                @error('body')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
...
>
    <div class="bg-white rounded-lg p-6 max-w-sm text-center shadow-lg">
        ...
        <p class="mb-6">Your note has been created successfully.</p>
        <a href="/">
            <button
